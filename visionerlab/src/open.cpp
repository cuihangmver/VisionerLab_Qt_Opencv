    ...
    ui(new Ui::Open)
{
    ...
    connect(m_pSpinBox, SIGNAL(valueChanged(int)), this, SLOT(ManualOpenChangeSlot(int)));
    connect(m_pSlider, SIGNAL(valueChanged(int)), this, SLOT(ManualOpenChangeSlot(int)));
    ...
    connect(button, SIGNAL(accepted()), parent, SLOT(OKOpenSliderSelectImg()));
    connect(button, SIGNAL(rejected()), parent, SLOT(CancelOpenSliderSelectImg()));
...
{
    connect(this, SIGNAL(sendManualOpenChange(int , QString)), m_parent, SLOT(ManualOpenChangeSlot(int, QString)));
    emit sendManualOpenChange(nValue, m_StructureType);
