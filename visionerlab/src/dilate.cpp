    ...
    ui(new Ui::Dilate)
{
    ...
    connect(m_pSpinBox, SIGNAL(valueChanged(int)), this, SLOT(ManualDilateChangeSlot(int)));
    connect(m_pSlider, SIGNAL(valueChanged(int)), this, SLOT(ManualDilateChangeSlot(int)));
    ...
    connect(button, SIGNAL(accepted()), parent, SLOT(OKDilateSliderSelectImg()));
    connect(button, SIGNAL(rejected()), parent, SLOT(CancelDilateSliderSelectImg()));
...
{
    connect(this, SIGNAL(sendManualDilateChange(int , QString)), m_parent, SLOT(ManualDilateChangeSlot(int, QString)));
    emit sendManualDilateChange(nValue, m_StructureType);
