    ...
    ui(new Ui::TopHat)
{
    ...
    connect(m_pSpinBox, SIGNAL(valueChanged(int)), this, SLOT(ManualTopHatChangeSlot(int)));
    connect(m_pSlider, SIGNAL(valueChanged(int)), this, SLOT(ManualTopHatChangeSlot(int)));
    ...
    connect(button, SIGNAL(accepted()), parent, SLOT(OKTopHatSliderSelectImg()));
    connect(button, SIGNAL(rejected()), parent, SLOT(CancelTopHatSliderSelectImg()));
...
{
    connect(this, SIGNAL(sendManualTopHatChange(int , QString)), m_parent, SLOT(ManualTopHatChangeSlot(int, QString)));
    emit sendManualTopHatChange(nValue, m_StructureType);
