    ...
    ui(new Ui::Laplace)
{
    ...
    connect(m_pSpinBox, SIGNAL(valueChanged(int)), this, SLOT(ManualLaplaceChangeSlot(int)));
    connect(m_pSlider, SIGNAL(valueChanged(int)), this, SLOT(ManualLaplaceChangeSlot(int)));
    ...
    connect(button, SIGNAL(accepted()), parent, SLOT(OKLaplaceSliderSelectImg()));
    connect(button, SIGNAL(rejected()), parent, SLOT(CancelLaplaceSliderSelectImg()));
...
{
    connect(this, SIGNAL(sendManualLaplaceChange(int )), m_parent, SLOT(ManualLaplaceChangeSlot(int)));
